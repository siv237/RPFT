\chapter{Допуск общего пространства конфигураций конечных геометрий концевого сектора}
\label{ch:v9-endpoint-finite-geometry-configuration-space}

\section{Три фазы как ортогональные компоненты}

Предыдущий запретительный результат требует расширить не одну fibre, а пространство допустимых
...
\end{equation}
выбирает constant mode, а не одну из фаз $21,23,24$. Никакой содержащий целевую подстановку
вершинный score в пространство конфигураций не вставлен.
...
Общее конечное пространство конфигураций построено без выбора target vertex, но
...
\begin{theorem}[Общее finite-geometry пространство конфигураций]

\chapter{Минимальная архитектура конечномерного модуля расширения концевого сектора}
\label{ch:v9-endpoint-finite-module}

\section{Два обязательных матричных блока}

Raw-origin запретительный результат выделил три новые system-линии. На нейтральной паре
...
\section{Точное вложение старого носителя}

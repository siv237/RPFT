...
- `version4_pati_salam_projected_curvature_selector_gate.tex`
- `s2t_v4_pati_salam_projected_curvature_selector.py`
- `s2t_v4_pati_salam_projected_curvature_selector_results.json`
- `s2t_v4_three_node_superconnection_closure_gate.py`
- `version4_relative_krajewski_star_gate.tex`
- `version4_vectorlike_messenger_chain_gate.tex`

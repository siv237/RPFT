...
- `version4_pati_salam_three_node_parent_graph_gate.tex`
- `s2t_v4_pati_salam_three_node_parent_graph.py`
- `s2t_v4_pati_salam_three_node_parent_graph_results.json`

...
- `main.tex`: 510839 bytes, successfully built to 112 pages.
- `tome2_s2t_spectral_closure.tex`: 427972 bytes, successfully built to 127 pages, including Part II.B and the exact rotor determinant audit.
...
- `s2t_project_preservation_audit.py`
- `s2t_project_preservation_results.json`
- `project_preservation_gate.tex`
...
- `version4_pati_salam_twisted_connector_threshold_gate.tex`
- `s2t_v4_pati_salam_twisted_connector_threshold_gate.py`
- `s2t_v4_pati_salam_twisted_connector_threshold_gate_results.json`

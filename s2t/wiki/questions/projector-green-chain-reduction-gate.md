...
- Source paths: `s2t_determinant_casmix_results.json`, `s2t_integer10_origin_results.json`, `s2t_mixed_trace_operator_results.json`, `s2t_c6_l21_coexact_basis_results.json`, `wiki/questions/projector-ambient-substitution-gate.md`.

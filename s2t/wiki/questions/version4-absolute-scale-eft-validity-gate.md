...
- `TOE.pdf`, gravitational matching on page 2
- `version4_absolute_scale_eft_validity_gate.tex`
- `s2t_v4_absolute_scale_eft_validity_gate.py`
- `s2t_v4_absolute_scale_eft_validity_gate_results.json`
...
- Visually checked page 2 of `TOE.pdf`.
...
- `TOE.pdf`, page 2
- `version4_spectral_gibbs_equivalence_gate.tex`
- `s2t_v4_spectral_gibbs_equivalence_gate.py`
- `s2t_v4_spectral_gibbs_equivalence_gate_results.json`
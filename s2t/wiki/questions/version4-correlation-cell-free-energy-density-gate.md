...
- `version4_correlation_cell_free_energy_density_gate.tex`
- `s2t_v4_correlation_cell_free_energy_density_gate.py`
- `s2t_v4_correlation_cell_free_energy_density_gate_results.json`
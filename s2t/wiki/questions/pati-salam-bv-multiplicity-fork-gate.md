...
- `version4_pati_salam_bv_multiplicity_fork_gate.tex`
- `s2t_v4_pati_salam_bv_multiplicity_fork_gate.py`
- `s2t_v4_pati_salam_bv_multiplicity_fork_gate_results.json`
...
- Source paths: `s2t_integer10_origin_results.json`, `s2t_determinant_casmix_results.json`, `s2t_c6_l21_metric_strain_tensor_results.json`, `wiki/questions/projector-green-chain-reduction-gate.md`, `wiki/questions/projector-ambient-substitution-gate.md`.

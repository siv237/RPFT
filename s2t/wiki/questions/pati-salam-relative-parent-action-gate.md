...
- `version4_pati_salam_relative_parent_action_gate.tex`
- `s2t_v4_pati_salam_relative_parent_action_gate.py`
- `s2t_v4_pati_salam_relative_parent_action_gate_results.json`

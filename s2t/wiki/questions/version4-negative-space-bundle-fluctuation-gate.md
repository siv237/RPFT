...
- `version4_negative_space_bundle_fluctuation_gate.tex`
- `s2t_v4_negative_space_bundle_fluctuation_gate.py`
- `s2t_v4_negative_space_bundle_fluctuation_gate_results.json`

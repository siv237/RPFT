...
- `s2t_relative_holonomy_determinant_audit.py`
- `s2t_relative_holonomy_determinant_results.json`
- `s2t_dual_completed_relative_functional_audit.py`
- `s2t_dual_completed_relative_functional_results.json`
- `s2t_ambient_reciprocal_duality_bridge_audit.py`
- `s2t_ambient_reciprocal_duality_bridge_results.json`
- `external_l21_spectrum_determinant_reproduction_results.json`
- `external_rp3xs1_winding_determinant_results.json`

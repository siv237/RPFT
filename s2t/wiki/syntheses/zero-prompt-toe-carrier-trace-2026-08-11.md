...
- Extracted and visually checked `TOE.pdf`, especially its fundamental
  operator, finite NCG space, and generation-topology sections.
- Checked `TOE5.pdf`, where the internal topological realization is listed
...
`TOE.pdf` uses three distinct geometric objects:
...
`TOE5.pdf` explicitly admits that constructing `M_int` is an unresolved
...
- `TOE.pdf`
- `17705966/TOE5.pdf`
- `toe_ugsm_common_shadow_bridge.tex`
- `version4_zero_prompt_toe_carrier_trace_gate.tex`
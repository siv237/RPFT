...
- `version4_pati_salam_rank_selector_archaeology_gate.tex`
- `s2t_v4_pati_salam_rank_selector_archaeology_results.json`
- `version4_common_updown_krajewski_loop_gate.tex`
- `version4_relative_krajewski_star_gate.tex`
- `version4_algebra_embedding_weighted_selector_gate.tex`
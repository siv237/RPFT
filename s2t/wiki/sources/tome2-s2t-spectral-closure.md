...
- The machine audit `s2t_tome2_audit.py` reproduces the closed numerical rows into `s2t_tome2_results.json` and explicitly does not close EW/QCD thresholds or the neutrino Dirac insertion.
...
- Source path: `tome2_s2t_spectral_closure.tex`.
- Companion paths: `technical_s2t_analysis.tex`, `s2t_tome2_audit.py`, `s2t_tome2_results.json`.

...
- Source paths: `external_literature_spectral_determinants_results.json`, `s2t_determinant_casmix_results.json`, `s2t_integer10_origin_results.json`.
...
The new audit `s2t_metric_variation_p02_audit.py` refines the `P_0,2` candidate into a conditional lemma.
...
The internal S2T selection audit `s2t_first_strain_selection_audit.py` adds a model-building criterion on top of the external determinant literature.

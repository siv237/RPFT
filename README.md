...
| `wiki/sources/*.md` (84) | Описания источников: тома, программа S2T, каталог, литература, корпуса; старый идентификатор Тома I сохранён как перенаправление | [Активно] |
| `wiki/syntheses/*.md` (39) | Сводки и результаты: систематика томов, дорожные карты, ведомости статусов, аудиты направлений | [Активно] |
| `wiki/questions/*.md` (420) | Гейты и вопросы: по сути индекс всех проверок проекта | [Активно] |
| `wiki/lints/*.md` (7) | Периодические проверки здоровья вики | [Справочно] |

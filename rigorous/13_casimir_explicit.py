#!/usr/bin/env python3
"""
ЯВНОЕ ВЫЧИСЛЕНИЕ КОЭФФИЦИЕНТА 1/24 ИЗ СПЕКТРАЛЬНОЙ СУММЫ

Цель: Показать, что ζ'_{L(2,1)×S¹}(0) ∝ 1/24 из первых принципов.
...
print("="*70)
print("ЯВНОЕ ВЫЧИСЛЕНИЕ 1/24 ИЗ СПЕКТРАЛЬНОЙ СУММЫ")
print("="*70)
...
# =============================================================================
# §5. ПРОИСХОЖДЕНИЕ 1/24 ИЗ HEAT KERNEL
# =============================================================================
...
Для 4D (d=4) с правильной нормировкой:
  δ_{Cas} = |(contribution to action)| = 1/24

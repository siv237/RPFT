...
- `s2t/docs/bl_nonuniform_pairing_working_package.tex`
...
- `s2t/results/s2t_spectral_pairing_stiffness_gate_results.json`
- `s2t/results/s2t_six_channel_inverse_susceptibility_results.json`
- `s2t/results/s2t_anomaly_free_holonomy_projection_results.json`
...
- Project derivation: `s2t/gates/version4_pati_salam_generalized_inner_fluctuation_gate.tex`.
- Reproduction code: `s2t/audits/s2t_v4_pati_salam_generalized_inner_fluctuation.py`.
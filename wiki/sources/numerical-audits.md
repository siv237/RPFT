...
- `s2t/results/spectral_unity_deep_results.json`
- `s2t/results/sector_attribution_results.json`
- `s2t/results/spectral_bridge_results.json`
- `s2t/results/dirac_unity_results.json`
- `s2t/results/gauge_holonomy_results.json`
- `s2t/results/dirac_spin_holonomy_results.json`
- `s2t/results/enriched_sector_map_results.json`
- `s2t/results/s2t_tome2_results.json`

## Extracted Metrics

- `s2t/results/s2t_tome2_results.json` reports closed rows for `S_vac = 137.03599917352236`, `m_tau = 1776.8594285630165 MeV`, `v_S2T = 245.99340926110546 GeV`, `lambda_H_S2T = 0.1292217159850974`, and `M_H = 125.05648603895122 GeV`.
- `s2t/results/s2t_tome2_results.json` reproduces the historical `S_vac` and tau numbers, but later determinant and tau-normalization audits show that numerical reproduction alone does not close either derivation.
- `s2t/results/dirac_spin_holonomy_results.json` sweeps five spin/holonomy twists with `theta/pi = 0, 0.25, 0.5, 0.75, 1.0`; max relative errors are `2.0624484157763978e-15` for `a0` and `2.4634800521773637e-13` for `a2`.
- `s2t/results/gauge_holonomy_results.json` sweeps five `beta` values from `0` to `0.5`; `theta_+/pi` runs from `1.0` to `2.0`, `theta_-/pi` runs from `1.0` to `0.0`, and the max `a2` relative error is `1.8092255825060733e-13`.
- `s2t/results/sector_attribution_results.json` separates sectors sharply: `mean_abs_da2_dmu = 445.693135731822`, `mean_abs_da2_dbeta = 2.530669007683173e-10`, and `sector_separation_ratio = 1761167242253.6758`.
- `s2t/results/enriched_sector_map_results.json` has 20 rows; `mu_heavy` moves mean `a2/(4π)` from about `-39.478417604356814` to `-71.39883714858775`, while `beta` changes holonomy phases with little movement in mean `a2`.
- `s2t/results/spectral_bridge_results.json` gives the scalar `S^3 x S^1` baseline with `a2_over_4pi_fit = 9.859598369516124`, expected `9.869604401089358`, and `pi_proxy_from_systole = 3.141592653589793`.
- `s2t/results/spectral_unity_deep_results.json` shows window dependence in scalar heat-trace fits: baseline `a2_rel_err = 0.0010138229624957501`, narrow `0.0004447891054027471`, and wide `0.0018158256009595196`.
...
- `s2t/results/s2t_coexact_tower_results.json`: projected coexact `RP^3` tower with `T_coex^RP3 = 1.5227161455271536e-05`, `RP3/S3 = 0.9939940192424161`, and first surviving mode fraction `0.9999756862947792`.
...
A new audit file `s2t/results/s2t_pi4_tower_hypothesis_results.json` tests whether the existing `pi^-4` term is a normalized coexact-tower residue.
...
New audit file: `s2t/results/s2t_pi4_residual_results.json`.
...
- `s2t/audits/s2t_c6_l21_normalization_audit.py`
- `s2t/results/s2t_c6_l21_normalization_results.json`
...
- `s2t/audits/s2t_c6_l21_shell_selection_audit.py`
- `s2t/results/s2t_c6_l21_shell_selection_results.json`
...
- `s2t/audits/s2t_c6_l21_coexact_locality_gate_audit.py`
- `s2t/results/s2t_c6_l21_coexact_locality_gate_results.json`
...
- `s2t/audits/s2t_c6_l21_low_shell_block_spec_audit.py`
- `s2t/results/s2t_c6_l21_low_shell_block_spec_results.json`
...
- `s2t/audits/s2t_c6_l21_n1_killing_overlap_audit.py`
- `s2t/results/s2t_c6_l21_n1_killing_overlap_results.json`
...
- `s2t/audits/s2t_c6_l21_n1_principal_symbol_audit.py`
- `s2t/results/s2t_c6_l21_n1_principal_symbol_results.json`
...
- `s2t/audits/s2t_c6_l21_n1_to_n3_leakage_audit.py`
- `s2t/results/s2t_c6_l21_n1_to_n3_leakage_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_coexact_gate_audit.py`
- `s2t/results/s2t_c6_l21_n3_coexact_gate_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_tangent_projection_audit.py`
- `s2t/results/s2t_c6_l21_n3_tangent_projection_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_intrinsic_divergence_audit.py`
- `s2t/results/s2t_c6_l21_n3_intrinsic_divergence_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_hodge_projection_audit.py`
- `s2t/results/s2t_c6_l21_n3_hodge_projection_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_proxy_obstruction_scale_audit.py`
- `s2t/results/s2t_c6_l21_n3_proxy_obstruction_scale_results.json`
...
- `s2t/audits/s2t_c6_l21_n3_explicit_basis_gate_audit.py`
- `s2t/results/s2t_c6_l21_n3_explicit_basis_gate_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_delta_gate_audit.py`
- `s2t/results/s2t_c6_l21_delta2_delta_gate_results.json`
...
- `s2t/audits/s2t_c6_closure_matrix_audit.py`
- `s2t/results/s2t_c6_closure_matrix_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_finite_block_spec_audit.py`
- `s2t/results/s2t_c6_l21_delta2_finite_block_spec_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_path_choice_gate_audit.py`
- `s2t/results/s2t_c6_l21_delta2_path_choice_gate_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_ambient_path_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_ambient_path_formula_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_operator_decomposition_audit.py`
- `s2t/results/s2t_c6_l21_delta2_operator_decomposition_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_principal_second_symbol_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_principal_second_symbol_formula_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_second_connection_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_second_connection_formula_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_second_ricci_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_second_ricci_formula_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_second_projector_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_second_projector_formula_results.json`
...
- `s2t/audits/s2t_c6_l21_delta2_second_hilbert_formula_audit.py`
- `s2t/results/s2t_c6_l21_delta2_second_hilbert_formula_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_local_counterterm_classifier_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_local_counterterm_classifier_results.json`
- Inputs:
  - `s2t/results/s2t_c6_l21_delta2_delta_gate_results.json`
  - `s2t/results/s2t_c6_l21_n3_finite_counterterm_gate_results.json`
  - `s2t/results/s2t_c6_l21_delta2_operator_decomposition_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_skeleton_completion_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_skeleton_completion_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_trace_phase_priority_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_trace_phase_priority_results.json`
- Inputs:
  - `s2t/results/s2t_c6_l21_delta2_skeleton_completion_results.json`
  - `s2t/results/s2t_c6_l21_delta2_finite_block_spec_results.json`
  - `s2t/results/s2t_c6_l21_delta2_ambient_path_formula_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_c11_setup_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_c11_setup_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_direction_reaudit_20260714_audit.py`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_timeboxed_operator_sprint_audit.py`
  - `s2t/results/s2t_c6_timeboxed_operator_sprint_results.json`
- Inputs:
  - `s2t/results/s2t_direction_reaudit_20260714_results.json`
  - `s2t/results/s2t_c6_l21_delta2_c11_setup_results.json`
  - `s2t/results/s2t_c6_l21_delta2_second_connection_formula_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_gamma_expansion_formula_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_gamma_expansion_formula_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_connection_laplacian_insertion_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_connection_laplacian_insertion_results.json`
...
- Scripts/results:
  - `s2t/audits/s2t_c6_l21_delta2_connection_product_terms_audit.py`
  - `s2t/results/s2t_c6_l21_delta2_connection_product_terms_results.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_product_index_cleanup_results.json`
...
- `s2t/audits/s2t_global_falsification_closure_audit.py`
...
- `s2t/results/s2t_c6_l21_delta2_connection_product_gamma_inserted_results.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_product_ambient_simplified_results.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_product_C11_moment_results.json`
- `s2t/results/s2t_c6_l21_delta2_connection_product_moment_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_single_gammaAB_ambient_simplified_results.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_single_gammaAB_C11_moment_results.json`
- `s2t/results/s2t_c6_l21_delta2_connection_single_gammaAB_moment_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_metric_cross_ambient_formula_results.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_metric_cross_C11_moment_results.json`
- `s2t/results/s2t_c6_l21_delta2_connection_metric_cross_moment_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_connection_full_C11_assembly_results.json`
- `s2t/results/s2t_c6_l21_delta2_connection_full_C11_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_principal_C11_moment_results.json`
- `s2t/results/s2t_c6_l21_delta2_principal_C11_moment_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_principal_plus_connection_C11_results.json`
- `s2t/results/s2t_c6_l21_delta2_principal_plus_connection_C11_table_data.json`
...
- `s2t/results/s2t_c6_l21_delta2_C11_table_reverification_results.json`

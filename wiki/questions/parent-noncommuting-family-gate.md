...
- `s2t/audits/s2t_parent_noncommuting_family_insertion_audit.py`
- `s2t/results/s2t_parent_noncommuting_family_insertion_results.json`
- `s2t/audits/s2t_projective_family_flux_audit.py`
- `s2t/results/s2t_projective_family_flux_results.json`
- `s2t/gates/parent_noncommuting_family_gate.tex`
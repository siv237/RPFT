...
- Source paths: `s2t/results/s2t_determinant_casmix_results.json`, `s2t/results/s2t_full_coexact_delta_results.json`, `s2t/results/s2t_c6_ghost_exact_isolation_results.json`, `s2t/results/s2t_c6_closure_matrix_results.json`, `wiki/questions/kappa-cas-one-over-24.md`, `wiki/syntheses/s2t-closure-roadmap.md`.

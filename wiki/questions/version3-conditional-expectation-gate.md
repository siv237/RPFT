...
the required doubled factor module must be derived from additional algebraic
structure.

Evidence:
- version3_conditional_expectation_gate.tex
- s2t_v3_conditional_expectation_results.json
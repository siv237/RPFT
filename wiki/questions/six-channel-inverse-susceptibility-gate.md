...
- `s2t/audits/s2t_six_channel_inverse_susceptibility_audit.py`
- `s2t/results/s2t_six_channel_inverse_susceptibility_results.json`
- `s2t/audits/s2t_selfdual_bilaplacian_susceptibility_audit.py`
- `s2t/results/s2t_selfdual_bilaplacian_susceptibility_results.json`
- `s2t/audits/s2t_halfshift_tensor_ghost_hessian_audit.py`
- `s2t/results/s2t_halfshift_tensor_ghost_hessian_results.json`
- `s2t/gates/six_channel_inverse_susceptibility_gate.tex`
...
- `s2t/audits/s2t_continuous_wilson_gap_action_audit.py`
- `s2t/results/s2t_continuous_wilson_gap_action_results.json`
- `s2t/gates/continuous_wilson_gap_action_gate.tex`
...
- `s2t/audits/s2t_su5_rank_action_gate_audit.py`
- `s2t/results/s2t_su5_rank_action_gate_results.json`
- `s2t/audits/s2t_su5_adjoint_relative_determinant_audit.py`
- `s2t/results/s2t_su5_adjoint_relative_determinant_results.json`
- `s2t/gates/su5_action_relative_determinant_gate.tex`
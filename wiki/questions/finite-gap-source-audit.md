...
- Source paths: `s2t/results/s2t_determinant_casmix_results.json`, `s2t/results/s2t_c6_ghost_exact_isolation_results.json`, `s2t/results/s2t_c6_closure_matrix_results.json`, `s2t/results/s2t_c6_l21_delta2_second_hilbert_formula_results.json`, `wiki/questions/kappa-cas-one-over-24.md`, `wiki/syntheses/current-status-and-next-vectors.md`, `wiki/syntheses/s2t-closure-roadmap.md`.
...
`R2` отсутствует в текущем одноформенном бимодуле `C^3`; не проверены
полное условие первого порядка, Real-совместимость, происхождение из одной
флуктуации, цветосохраняющий вакуум и семейный селектор.

...
Known skeleton from `s2t/results/s2t_c6_l21_delta2_second_projector_formula_results.json`:
...
Known skeleton from `s2t/results/s2t_c6_l21_delta2_second_hilbert_formula_results.json`:
...
From `s2t/results/s2t_c6_l21_delta2_finite_block_spec_results.json`, the determinant trace term
...
- Source paths: `s2t/results/s2t_c6_l21_delta2_second_projector_formula_results.json`, `s2t/results/s2t_c6_l21_delta2_second_hilbert_formula_results.json`, `s2t/results/s2t_c6_l21_delta2_finite_block_spec_results.json`, `s2t/results/s2t_c6_l21_delta2_principal_plus_connection_C11_results.json`, `wiki/questions/finite-gap-source-audit.md`.
...
- `s2t/audits/s2t_shared_holonomy_two_sector_audit.py`
- `s2t/results/s2t_shared_holonomy_two_sector_results.json`
- `s2t/gates/shared_holonomy_two_sector_gate.tex`
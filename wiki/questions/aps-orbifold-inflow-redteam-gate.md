...
- `s2t/audits/s2t_aps_orbifold_inflow_redteam_audit.py`
- `s2t/results/s2t_aps_orbifold_inflow_redteam_results.json`
- `s2t/gates/aps_orbifold_inflow_redteam_gate.tex`
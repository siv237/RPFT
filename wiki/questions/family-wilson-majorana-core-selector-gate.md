...
- `s2t/audits/s2t_family_wilson_majorana_core_selector_audit.py`
- `s2t/results/s2t_family_wilson_majorana_core_selector_results.json`
- `s2t/gates/family_wilson_majorana_core_selector_gate.tex`

...
- `s2t/audits/s2t_two_layer_physical_ckm_redteam_audit.py`
- `s2t/results/s2t_two_layer_physical_ckm_redteam_results.json`
- `s2t/gates/two_layer_physical_ckm_redteam_gate.tex`

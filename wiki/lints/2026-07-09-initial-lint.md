...
- Most pages are based on `s2t/docs/RESEARCH_CATALOG.md` and filename-level inspection, not full source extraction.
...
1. `s2t/docs/toe_ugsm_unified_shadow_paper.tex`
2. `s2t/docs/toe_ugsm_shadow_audit_report.tex`
3. `s2t/docs/tome2_s2t_spectral_closure.tex`
4. `s2t/results/spectral_bridge_results.json` and related audit files

...
- `s2t/docs/tome2_s2t_spectral_closure.tex` still needs full source-level ingest.
- `s2t/docs/toe_ugsm_unified_shadow_paper.tex` remains the main bridge source but is still summarized at a high level.
...
1. Ingest `s2t/docs/tome2_s2t_spectral_closure.tex` in detail.
